      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            var minSrc = 'https://coding.net/u/raincal/p/blog-photos/git/raw/master/min_photos/' + data.link[i];
            var src = 'https://coding.net/u/raincal/p/blog-photos/git/raw/master/com_photos/' + data.link[i];
